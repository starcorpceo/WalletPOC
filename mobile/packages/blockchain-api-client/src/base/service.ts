import { Balance, BroadcastTransaction, Fees, Provider, Transaction } from './types';
...
export interface Service {
  ...
  sendBroadcastTransaction: (txData: string, provider: Provider) => Promise<BroadcastTransaction>;
}
